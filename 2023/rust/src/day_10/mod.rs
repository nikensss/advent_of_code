...
mod tests {
    ...
    const TEST_INPUT_1: &str = include_str!("../day_10/test-input-1.txt");
    const TEST_INPUT_2: &str = include_str!("../day_10/test-input-2.txt");
    const TEST_INPUT_3: &str = include_str!("../day_10/test-input-3.txt");
    const TEST_INPUT_4: &str = include_str!("../day_10/test-input-4.txt");
    const TEST_INPUT_5: &str = include_str!("../day_10/test-input-5.txt");
    const TEST_INPUT_6: &str = include_str!("../day_10/test-input-6.txt");
    const COMPLETE_INPUT: &str = include_str!("../day_10/complete-input.txt");
